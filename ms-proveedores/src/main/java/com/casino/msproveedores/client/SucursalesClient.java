package com.casino.msproveedores.client;
...
// name: nombre único del bean en Spring — ms-sucursales-proveedores para diferenciarlo
//       de otros microservicios que también llaman a ms-sucursales
// url: dirección del microservicio destino en el entorno local
@FeignClient(name = "ms-sucursales-proveedores", url = "http://localhost:8083")
public interface SucursalesClient {
    ...
    // Usado para verificar que la sede exista y esté operativa antes de crear una orden
