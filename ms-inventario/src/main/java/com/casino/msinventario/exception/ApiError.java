package com.casino.msinventario.exception;
...
public class ApiError {
    ...
    // Ejemplo: "Ingrediente no encontrado", "La sede no está operativa"
    private String message;

    // Lista de detalles adicionales del error
    // Usado principalmente para errores de validación Bean Validation
    // Ejemplo: ["nombreIngrediente: El nombre es obligatorio", "sedeId: La sede es obligatoria"]
